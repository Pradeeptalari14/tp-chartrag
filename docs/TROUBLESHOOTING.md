# 🔧 Troubleshooting Guide — ChartRAG
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-chartrag/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/chartrag/)
