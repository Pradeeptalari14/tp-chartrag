...
> Specialized chart image reader querying data labels and layout coordinates using GPT-4o.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/chartrag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-chartrag.git
cd tp-chartrag
```
...
```bash
kubectl port-forward deployment/tp-chartrag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── chart_retriever.py     # Main configuration file
```
...
---
*Generated by [ChartRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/chartrag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
